...
| 题号 | 知识点 | 树路径 |
|------|------|------|
| Q1 | DeepSeek-V4 MoE（284B/13B激活） | ⑤微调→MoE |
| Q2 | CSA+HCA关系 | ④LLM→推理优化 |
| Q3-5 | BBPE分词 | ④LLM→分词 |
| Q6-8 | 量化基础 | ⑤微调→量化 |
| Q9 | 不量化的层 | ⑤微调→量化 |
| Q10 | AWQ vs GPTQ | ⑤微调→量化 |
| Q11 | DeepSeek V4-Pro编程最强 | ⑤微调→推理部署 |
| Q12 | 量化粒度(per-tensor/channel/group) | ⑤微调→量化 |
| Q13 | 模型越大量化损失越小 | ⑤微调→量化 |
| Q14 | 量化损失本质 | ⑤微调→量化 |
| Q15 | AWQ放大系数s原理(简答) | ⑤微调→量化 |

**新增入库**：K187-K190（4题 CSA+HCA/量化粒度/大模型损失小/AWQ缩放）
