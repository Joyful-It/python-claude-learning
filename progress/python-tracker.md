...
| 训练循环五步 | 65% | 2026-05-19 | forward→loss→backward→step→zero_grad 已背下 |
...
| IMDB 情感分析项目 | 35% | 2026-05-26 | 10步流程(导入→数据→模型→token化→对齐→参数→指标→组装→训练→保存)，骨架6步可写出 |
| 大模型显存评估 | 45% | 2026-05-27 | 推理公式(B×字节×1.2)、FP16/INT8/INT4、训练≈推理×4、LoRA/QLoRA显存对比 |
