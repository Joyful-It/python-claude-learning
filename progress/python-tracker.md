...
| 函数参数（四种形式） | 25% | 2026-03-30 | 今日复习课件，需实操巩固 |
| 类与对象概念 | 35% | 2026-03-30 | 今日预习：理解类=模板，对象=实例 |
| __init__ 初始化方法 | 20% | 2026-03-30 | 今日预习：知道是初始化，需巩固 |
| self 的含义 | 15% | 2026-03-30 | 今日预习：知道是形参+指针，但还需巩固 |
| 属性与方法 | 30% | 2026-03-30 | 今日预习：能区分属性（是什么）和方法（能做什么） |
| 函数返回值（return） | 0% | 2026-03-30 | 未开始 |
| 变量作用域 | 0% | 2026-03-30 | 未开始 |

**A.1 综合掌握度：23%** ⬆️ 较昨日提升
...
| A.1 | self 概念理解不够牢固 | 中 | 2026-03-30 | 跟进中 |
...
2. [ ] 函数参数四种形式 → 目标 60%
3. [x] 面向对象基础（类、对象、__init__、self）→ 已预习，目标继续深入
4. [ ] 函数返回值（return）→ 目标 50%
5. [ ] 变量作用域 → 目标 40%

### 明日计划
- 深入学习面向对象编程
- 课前小测：让学员写一个"狗"类，检验预习效果
